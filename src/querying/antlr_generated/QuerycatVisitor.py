...
class QuerycatVisitor(ParseTreeVisitor):
    ...
    def visitGraphPatternNotTriples(self, ctx:QuerycatParser.GraphPatternNotTriplesContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#optionalGraphPattern.
    def visitOptionalGraphPattern(self, ctx:QuerycatParser.OptionalGraphPatternContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#groupOrUnionGraphPattern.
    def visitGroupOrUnionGraphPattern(self, ctx:QuerycatParser.GroupOrUnionGraphPatternContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by QuerycatParser#graphTerm.
    ...
    def visitConditionalOrExpression(self, ctx:QuerycatParser.ConditionalOrExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#conditionalAndExpression.
    def visitConditionalAndExpression(self, ctx:QuerycatParser.ConditionalAndExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitRelationalExpression(self, ctx:QuerycatParser.RelationalExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#numericExpression.
    def visitNumericExpression(self, ctx:QuerycatParser.NumericExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#additiveExpression.
    def visitAdditiveExpression(self, ctx:QuerycatParser.AdditiveExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#multiplicativeExpression.
    def visitMultiplicativeExpression(self, ctx:QuerycatParser.MultiplicativeExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#unaryExpression.
    def visitUnaryExpression(self, ctx:QuerycatParser.UnaryExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitBrackettedExpression(self, ctx:QuerycatParser.BrackettedExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#regexExpression.
    def visitRegexExpression(self, ctx:QuerycatParser.RegexExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitNumericLiteralUnsigned(self, ctx:QuerycatParser.NumericLiteralUnsignedContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#numericLiteralPositive.
    def visitNumericLiteralPositive(self, ctx:QuerycatParser.NumericLiteralPositiveContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by QuerycatParser#numericLiteralNegative.
    def visitNumericLiteralNegative(self, ctx:QuerycatParser.NumericLiteralNegativeContext):
        return self.visitChildren(ctx)
